 ...
 * @author user
 */
public class MailClientApplet extends javax.swing.JApplet {
    ...
    /**
     * Initializes the applet MailClientGUI
     */
    @Override
    public void init() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MailClientApplet.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
